...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex py-3  w-full item-center justify-between rounded-md border text-base border-white/10 bg-primary px-4   text-white/60 placeholder:text-white/10 focus:border-accent outline-none ",
        className
      )}
      {...props}
    >
